...
The typical data movement process includes moving data from the database for use in other external 
...
n the following sections we describe each portion of the pipeline.
