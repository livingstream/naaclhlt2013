...
One way to acheive this is for the datastore to be in the same location as the analytic engine.
...
and investing in open source libraries that ta
...
We materialize  store single and two-state features to avoid feature re-computation for the same token.  
...
Our work is inspired by MADLib \cite{Hellerstein:2012:MAL:2367502.2367510}, but implementation has a lot in common with Feng's work \cite{Feng:2012:TUA:2213836.2213874}.
