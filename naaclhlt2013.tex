...
\EndFor
\State $w_{new} \gets Finalization(\mathit{state})$ \Comment{Invoke L-BFGS convex solver}
...
Our POS implementation acheives $.9715$ accuracy, this is consitant with the state of the art \cite{Manning:2011:PT9:1964799.1964816}.
